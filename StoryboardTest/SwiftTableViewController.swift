...
{
    var players: [SwiftClass] = playersData
...
//        -> UITableViewCell {
//            let cell = tableView.dequeueReusableCell(withIdentifier: "PlayerCell", for: indexPath as IndexPath)
//                as UITableViewCell
//            
//            let player = players[indexPath.row] as SwiftClass
